package com.zonekey.disrec.common.cache;
...
/**
* @Title: SpyMemcachedClient.java
* @Description: <p>对SpyMemcached Client的二次封装,提供常用的Get/GetBulk/Set/Delete/Incr/Decr函数的同步与异步操作封装.未提供封装的函数可直接调用getClient()取出Spy的原版MemcachedClient来使用.</p>
* @author <a href="mailto:cuiwx@zonekey.com.cn">cuiwx</a> 
* @date 2014年8月28日 下午3:55:05   
* @version v 1.0 
*/ 
