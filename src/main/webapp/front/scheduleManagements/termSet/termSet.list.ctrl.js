define(['app','config'], function (app,config) {
    app.registerController('TermSetCtrl', ['$scope','$modal','growl','ScheduleService', function ($scope,$modal,growl,ScheduleService) {
    	...
    	//设置打开新标签
    	$scope.backScheduleWindow = function(){
//    		window.open('index.html#/scheduleManagements/edit');
        ...
        $scope.editTermModal = function (termset) {
            var modalInstance = $modal.open({
                templateUrl: 'scheduleManagements/termSet/list/termSet.add.modal.html',
                backdrop:'static',
        ...
        var EditTermModalCtrl = function ($scope, $modalInstance, termset,growl,NotChrome) {
        ...
        var AddModalCtrl = function ($scope, $modalInstance, termset,growl,NotChrome) {
            $scope.editingMode = termset? true:false;
            $scope.NotChrome = NotChrome;
            //添加教室--学期名称--后台校验
...
//            };
        ...
        $scope.currentSemester = function (termname) {
            var modalInstance = $modal.open({
                templateUrl: 'scheduleManagements/termSet/list/term.current.modal.html',
                backdrop:'static',
