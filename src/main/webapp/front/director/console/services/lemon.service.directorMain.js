    ...
    angular.module('lemon.service.directorMain', [])
        .constant('DirectorMainServiceConfig', {
            ...
            urls:{
                ...
                getDirectorHeaderData:  config.backend.ip + config.backend.base +'rest/curriculum/selectEndtimeByBatch',
...
//                    var _url=DirectorMainServiceConfig.urls.recordingStatus;
              ...
              //权限
                 ...
                 * 记录录像状态方法
                 */
                recordingStatus:function(mac){
                    var deffered=$q.defer();
                    var _url = config.data.method==='files'?DirectorMainServiceConfig.files.recordingStatus: DirectorMainServiceConfig.urls.recordingStatus + "?mac=" + mac;
//                    var _url=DirectorMainServiceConfig.urls.recordingStatus;
                    $http({
                        method: 'get',
                        dataType:"json",
