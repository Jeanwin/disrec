...
//                        throw(code);
        ...
        $scope.recordingliveMode = function (mac, para) {
        	var url_ = $scope.activedeviceServiceurl + "living?mac=" + mac + "&para=" + para + "&endTime=" + $scope.ymdendTime + " " +$scope.endTime  + "&isLive=0";
            exec(url_);
        };
...
//        	startTime = "2014-12-26 23:59:00";
//        	$scope.startTime = startTime.split(" ")[1];
...
//            	console.log("有后续 课程");
//            	$scope.laterCourseFlag = true;
//            	$scope.courseStartTime = "课程开始时间 " + startTime;
//            } else {
//            	$scope.laterCourseFlag = false;
//            }
        };
...
//            ?mac=0A242119BDE4&reqUserName=admin&classId=0001212#/dashboard
            ...
            var svgTimeOutSet = $timeout(function(){
            	var svgDoc1 = document.getElementById("svgmapctrl1").getSVGDocument();
            	if(svgDoc1 != null){
            		var macValue1 = svgDoc1.getElementById("macValue1");
                    macValue1.setAttribute("value",$scope.mac);
                    var urlAdressValue1 = svgDoc1.getElementById("urlAdressValue1");
                    urlAdressValue1.setAttribute("value",$scope.activedeviceServiceurl);
                    var titleValue = svgDoc1.getElementById("titleValue1");
                    titleValue.setAttribute("value",$scope.VideosInformations[0].title);
            	}
            	if(document.getElementById("svgmapctrl2") != null){
                	var svgDoc2 = document.getElementById("svgmapctrl2").getSVGDocument();
                	if(svgDoc2 != null){
                		var macValue2 = svgDoc2.getElementById("macValue2");
                        macValue2.setAttribute("value",$scope.mac);
                        var urlAdressValue2 = svgDoc2.getElementById("urlAdressValue2");
                        urlAdressValue2.setAttribute("value",$scope.activedeviceServiceurl);
                        var titleValue = svgDoc2.getElementById("titleValue2");
                        titleValue.setAttribute("value",$scope.VideosInformations[1].title);
                	}
                }
            	if(document.getElementById("svgmapctrl3") != null){
                	var svgDoc3 = document.getElementById("svgmapctrl3").getSVGDocument();
                	if(svgDoc3 != null){
                		var macValue3 = svgDoc3.getElementById("macValue3");
                        macValue3.setAttribute("value",$scope.mac);
                        var urlAdressValue3 = svgDoc3.getElementById("urlAdressValue3");
                        urlAdressValue3.setAttribute("value",$scope.activedeviceServiceurl);
                        var titleValue = svgDoc3.getElementById("titleValue3");
                        titleValue.setAttribute("value",$scope.VideosInformations[2].title);
                	}
                }
            	
            	if(document.getElementById("svgmapctrl4") != null){
                	var svgDoc4 = document.getElementById("svgmapctrl4").getSVGDocument();
                	if(svgDoc4 != null){
                		var macValue4 = svgDoc4.getElementById("macValue4");
                        macValue4.setAttribute("value",$scope.mac);
                        var urlAdressValue4 = svgDoc4.getElementById("urlAdressValue4");
                        urlAdressValue4.setAttribute("value",$scope.activedeviceServiceurl);
                        var titleValue = svgDoc4.getElementById("titleValue4");
                        titleValue.setAttribute("value",$scope.VideosInformations[3].title);
                	}
                } else {
                	console.log("svgTimeOutSet end ");
                	$timeout.cancel(svgTimeOutSet);
                }
...
//            var svgDoc1 = document.getElementById("svgmapctrl1").getSVGDocument();
            ...
            /*var setIntervalSet = $interval(function(){
            	
            	if($scope.urlParam1 === "urlParam1" || $scope.urlParam2 === "urlParam2" 
            		|| $scope.urlParam3 === "urlParam3" || $scope.urlParam4 === "urlParam4"){
    				console.log("未获取到值");
    				$("#back-info1").css("display","block");
    				$("#flashContent1").css("display","none");
    				$("#lone_rtmp_player1").css("display","none");
    				$("#back-info2").css("display","block");
    				$("#flashContent2").css("display","none");
    				$("#lone_rtmp_player2").css("display","none");
    				...
    				var svgDoc1 = document.getElementById("svgmapctrl1").getSVGDocument();
    				//如果不为空串的直播流地址 获取到 svgDocument，则停止轮询
    			}
            },1000);*/
        };
            ...
            /*$scope.videoPreviewObject = [
							    {
							        ...
							        "card4": "rtmp://192.168.12.117:51935/zonekey/00e04c680001_vga"
							    }
							];
	         $scope.urlParam1 = $scope.videoPreviewObject[0].card0;
	         $scope.urlParam2 = $scope.videoPreviewObject[0].card1;
