...
define(['angular', 'config'], function (angular, config) {
     ...
     * 分出业务非比例管理
     ------------------------------------------*/
    angular.module('lemon.service.teacher', [])
        .constant('TeacherServiceConfig', {
            files:{
                searchTeacher:  'data/teacher.list.json'
                }
            ,
            urls:{
                searchTeacher: config.backend.ip + config.backend.base + 'xolContBill/parepareImportComShare.do'
                }
        })
        .factory('TeacherService',['$http', '$q', 'TeacherServiceConfig', function ($http, $q, TeacherServiceConfig) {
            return {
                 ...
                 */
                searchTeacher : function(keywords){
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?TeacherServiceConfig.files.searchTeacher: TeacherServiceConfig.urls.searchTeacher;
                    $http({
