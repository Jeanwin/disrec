...
define(['angular', 'config'], function (angular, config) {
     ...
     * 分出业务非比例管理
     ------------------------------------------*/
    angular.module('lemon.service.live', [])
        .constant('LiveServiceConfig', {
            ...
            ,
            urls:{
                searchLive: config.backend.ip + config.backend.base + 'xolContBill/parepareImportComShare.do'
                }
        })
        .factory('LiveService',['$http', '$q', 'LiveServiceConfig', function ($http, $q, LiveServiceConfig) {
            return {
                 ...
                 */
                searchLive : function(keywords, pagination, user){
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?LiveServiceConfig.files.searchLive: LiveServiceConfig.urls.searchLive;
                    $http({
