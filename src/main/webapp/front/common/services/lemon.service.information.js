...
define(['angular', 'config'], function (angular, config) {
     ...
     * 消息
     ------------------------------------------*/
    angular.module('lemon.service.information', [])
        .constant('InformationServiceConfig', {
            files:{
                informationes:       'data/information.list.json',
                DeleteInformation:       'data/information.list.json',
            ...
            ,
            urls:{
                informationes: config.backend.ip + config.backend.base + 'rest/resource/deleteVideoResource',
                DeleteInformation: config.backend.ip + config.backend.base + 'rest/resource/deleteVideoResource',
        ...
        .factory('InformationService',['$http', '$q', 'InformationServiceConfig', function ($http, $q, InformationServiceConfig) {
            return {
                 ...
                 */
                 //全部消息
                informationes : function(keywords,pagination, user){
                    console.log("informationes里的keywords",keywords);
                    console.log("informationes里的pagination",pagination);
                    console.log("informationes里的user",user);
                    console.log("进入informationes服务以后，输出传入的值");
                    var deffered = $q.defer();
                    pagination.offset = pagination.pageIndex;
                    pagination.limit = pagination.pageSize*1;
                    var _url = config.data.method==='files'?InformationServiceConfig.files.informationes: InformationServiceConfig.urls.informationes;
                    $http({
                ...
                //消息删除
                DeleteInformation : function(information){
                    console.log("DeleteInformation里service的参数information：",information);
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'? InformationServiceConfig.files.DeleteInformation : InformationServiceConfig.urls.DeleteInformation;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
...
//                            lan:lan
                ...
                deleteUpload: function (facilityNo, user) {
                    ...
                    $http({
                        method:config.data.method==='files'? 'GET':'POST',
                        /*InformationServiceConfig是对比的顶部的静态变量*/
                        /*config.data.method在config.js中取得的值*/
                        /*.deleteUpload执行这个接口里边的json*/
                        url: config.data.method==='files'?InformationServiceConfig.files.deleteUpload: InformationServiceConfig.urls.deleteUpload,
                        headers: {
                ...
                deleteVideos: function (VideoNo, user) {
                    ...
                    $http({
                        ...
                        /*config.data.method在config.js中取得的值*/
                        /*.deleteUpload执行这个接口里边的json*/
                        url: config.data.method==='files'?InformationServiceConfig.files.deleteVideos: InformationServiceConfig.urls.deleteVideos,
                        headers: {
                            //PICC__RequestVerificationToken: user.verificationToken
                        },
                        /*给后台传的值*/
                ...
                deleteImages: function (ImageNO, user) {
                    ...
                    $http({
                        ...
                        /*config.data.method在config.js中取得的值*/
                        /*.deleteUpload执行这个接口里边的json*/
                        url: config.data.method==='files'?InformationServiceConfig.files.deleteImages: InformationServiceConfig.urls.deleteImages,
                        headers: {
                            //PICC__RequestVerificationToken: user.verificationToken
                        },
                        /*给后台传的值*/
                ...
                CancelReleaseds:function (ReleasedNO, user) {
                    ...
                    $http({
                        ...
                        /*config.data.method在config.js中取得的值*/
                        /*.deleteUpload执行这个接口里边的json*/
                        url: config.data.method==='files'?InformationServiceConfig.files.deleteReleaseds: InformationServiceConfig.urls.deleteReleaseds,
                        headers: {
                            //PICC__RequestVerificationToken: user.verificationToken
                        },
                        /*给后台传的值*/
                ...
                updateVideos: function(video){
                    ...
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?InformationServiceConfig.files.updateVideos: InformationServiceConfig.urls.updateVideos;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                updateImage: function(Image){
                    ...
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?InformationServiceConfig.files.updateImage: InformationServiceConfig.urls.updateImage;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                updateReleased: function(Released){
                    ...
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?InformationServiceConfig.files.updateReleased: InformationServiceConfig.urls.updateReleased;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                resourceReleaseds : function(keywords, pagination,user){
                    ...
                    pagination.offset = pagination.pageIndex;
                    pagination.limit = pagination.pageSize *1;
                    var _url = config.data.method==='files'?InformationServiceConfig.files.resourceReleaseds: InformationServiceConfig.urls.resourceReleaseds;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                resourceupmid : function(keywords,areaid,pagination,user){
                    ...
                    pagination.offset = pagination.pageIndex;
                    pagination.limit = pagination.pageSize*1;
                    var _url = config.data.method==='files'?InformationServiceConfig.files.resourceupmid: InformationServiceConfig.urls.resourceupmid;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                resourceUpload : function(keywords,areaid,pagination, user){
                    ...
                    pagination.offset = pagination.pageIndex;
                    pagination.limit = pagination.pageSize*1;
                    var _url = config.data.method==='files'?InformationServiceConfig.files.resourceUpload: InformationServiceConfig.urls.resourceUpload;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
...
//                            "sort":""
                ...
                resourceVideo : function(keywords, pagination, user){
                    ...
                    pagination.offset = pagination.pageIndex;
                    pagination.limit = pagination.pageSize *1;
                    var _url = config.data.method==='files'?InformationServiceConfig.files.resourceVideo: InformationServiceConfig.urls.resourceVideo;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                videoRelease: function(keywords){
                    ...
                    var deffered = $q.defer();
                    var _url = config.data.method==='files'?InformationServiceConfig.files.videoRelease: InformationServiceConfig.urls.videoRelease;
                    $http({
                        method: config.data.method==='files'? 'GET':'POST',
                        dataType: "json",
                        contentType:'application/json; charset=UTF-8',
                ...
                console.log("进入videoRelease服务以后输出传入的值");
                var deffered = $q.defer();
                var _url = config.data.method==='files'?InformationServiceConfig.files.CancelVideoRelease: InformationServiceConfig.urls.CancelVideoRelease;
                $http({
                    method: config.data.method==='files'? 'GET':'POST',
                    dataType: "json",
                    contentType:'application/json; charset=UTF-8',
