...
(function() {
    ...
    var CouchPotato = function(angular) {
         ...
         *    <pre>
         *   <!-- in index.html -->
         *   <script src="/app/angular.min.app"></script>
         *   <script src="/app/angular-couch-potato.min.app"></script>
         *   <script src="/app/require.min.app"></script>
         *   </pre>
         *
         * #### B. Use RequireJS
         *
         ...
         *  from a script tag (if you do so before your require.app script tag)
