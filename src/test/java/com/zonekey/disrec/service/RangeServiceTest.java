...
/**
 * @Title: @{#} RangeServiceTest.java
 * @Description: <p>RangeService的CRUD测试.</p>
 * @author <a href="mailto:cuiwx@zonekey.com.cn">cuiwx</a>
 * @date 2014年9月20日 下午7:37:47
 * @version v 1.0
 */
@ContextConfiguration(locations={"/applicationContext.xml"})
public class RangeServiceTest extends SpringTxTestCase{
	...
	public void getRange() {
		System.out.println(JsonUtil.toJson(rangeService.getScope()));
	}
